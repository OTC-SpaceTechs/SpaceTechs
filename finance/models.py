...
class PurchaseRequest(models.Model):
    ...
    approved_by = models.ForeignKey("membership.Member", on_delete=models.SET_NULL, null=True, blank=True, related_name="purchase_requests_approved", verbose_name="Reviewed by")
